            ...
            <div class="sui-navbar">
              <div class="navbar-inner filter">
                <ul class="sui-nav">
                  <li
                    @click="changeOrder(1)"
                    :class="{ active: totalIndicator }"
                  >
                    <a
                      >综合<span
                        v-show="totalIndicator"
                        class="iconfont"
                        :class="{
                  ...
                  <li
                    @click="changeOrder(2)"
                    :class="{ active: salesIndicator }"
                  >
                    <a
                      >价格
                      <span
                        v-show="salesIndicator"
                        class="iconfont"
                        :class="{
                          'icon-asc': ascIndicator,
                          'icon-desc': descIndicator,
...
import SearchSelector from "@/components/pages/Search/SearchSelector/SearchSelector";
export default {
  name: "Search",
  data() {
    return {
  ...
  // 拼接当前路由中的参数，合并给 this.searchParams
  beforeMount() {
  ...
  methods: {
    ...
    removeBread() {
      ...
      if (this.$route.params) {
        this.$router
          .push({ name: "search", params: this.$route.params })
          .catch((err) => err);
      }
    },
    removeBreadKeyword() {
